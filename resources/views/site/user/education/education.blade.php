	...
	@for($i = 1; $i <= $number_of_educations; $i++)
		...
		<div class="education" data-education="{{$i}}">
			...
			<div class="form-group @if ($errors->has('ed_course_.'.$i)) has-error @endif">
				...
				<input type="text" class="form-control" name="ed_course_[{{$i}}]" placeholder="Curso" value="{{old('ed_course_.'.$i)}}">
			...
			<div class="form-group semester @if ($errors->has('ed_semester_.'.$i)) has-error @endif" id="semester_{{$i}}">
				...
				<input type="number" class="form-control" name="ed_semester_[{{$i}}]" placeholder="Ex: 6" value="{{old('ed_semester_.'.$i)}}">
			...
			<div class="add-post-btn crea" id="crea_{{$i}}">
				...
				<div class="pull-left" id="crea-number">
					<div class="form-group @if ($errors->has('ed_crea_number_.'.$i)) has-error @endif">
						...
						<input type="number" class="form-control" name="ed_crea_number_[{{$i}}]" placeholder="Ex: 123456" value="{{old('ed_crea_number_.'.$i)}}">
			...
			<div class="form-group @if ($errors->has('ed_college_.'.$i)) has-error @endif">
				...
				<input type="text" class="form-control" name="ed_college_[{{$i}}]" placeholder="Ex: UniRitter" value="{{old('ed_college_.'.$i)}}">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-md-6 @if ($errors->has('ed_end_date_.'.$i)) has-error @endif">
						...
						<input type="number" class="form-control" name="ed_end_date_[{{$i}}]" placeholder="Ex: 2018" value="{{old('ed_end_date_.'.$i)}}">
