	...
	@for($i = 1; $i <= $number_of_educations; $i++)
		...
		<div class="education" data-education="{{$i}}">
			<div class="form-group @if ($errors->has('ed_select_degree_.'.$i)) has-error @endif">
				<label class="control-label" for="ed_select_degree_[{{$i}}]"><span class="fa fa-asterisk required" aria-hidden="true"></span> Grau</label>
			...
			<div class="form-group @if ($errors->has('ed_select_course_.'.$i)) has-error @endif">
				<label class="control-label" for="textarea"><span class="fa fa-asterisk required" aria-hidden="true"></span> Curso</label>
			...
			<div class="form-group other_course @if ($errors->has('ed_other_course_.'.$i)) has-error @endif" id="other_course_{{$i}}">
				<label class="control-label" for="ed_other_course_[{{$i}}]"><span class="fa fa-asterisk required" aria-hidden="true"></span> Outro Curso</label>
			...
			<div class="form-group semester @if ($errors->has('ed_semester_.'.$i)) has-error @endif" id="semester_{{$i}}">
				<label class="control-label" for="textarea"><span class="fa fa-asterisk required" aria-hidden="true"></span> Semestre</label>
			...
			<div class="form-group @if ($errors->has('ed_college_.'.$i)) has-error @endif">
				<label class="control-label" for="textarea"><span class="fa fa-asterisk required" aria-hidden="true"></span> Instituição de ensino</label>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-md-6 @if ($errors->has('ed_start_date_.'.$i)) has-error @endif">
						<label class="control-label" for="textarea"><span class="fa fa-asterisk required" aria-hidden="true"></span> Ano de Início</label>
